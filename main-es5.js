...
var BillingUpdateComponent = /** @class */ (function () {
    function BillingUpdateComponent(snackBar, fb, route, _contactService) {
    ...
    BillingUpdateComponent.prototype.ngOnInit = function () {
    ...
    ///Quantity List
    BillingUpdateComponent.prototype.onSearchChange = function (searchValue) {
    ...
    BillingUpdateComponent.prototype.customerListMeth = function () {
        var _this = this;
        this._contactService.getCustomerList(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'getCustomerList')
            ...
            var cusNamendex = _this.customerList.findIndex(function (x) { return x.code.trim().toLocaleLowerCase() === _this.cusCode; });
            var cusAddress = _this.customerList[cusNamendex].address;
            _this.customerAddress = cusAddress;
            _this.billingFrm = _this.fb.group({
                ...
                code: [_this.cusCode],
                date: [_this.datehdr],
                bill: [_this.billNumber],
                mobile: [_this.mobileNumber],
                paymentType: [''],
                referenceNo: [''],
                cusName: [_this.customerName],
                CusAddress: [_this.customerAddress],
                totalAddAmount: [_this.totalAmount]
            });
        });
    };
    //Product table List
    BillingUpdateComponent.prototype.manuList = function () {
        var _this = this;
        this._contactService.getManuList2(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT + 'getAllProd')
            ...
            _this.productList = manufacturer;
        });
    };
    BillingUpdateComponent.prototype.paymentList = function () {
        var _this = this;
        this._contactService.getManuListPaymentLatest(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT + 'getPaymentListCtrl', this.billNumber).subscribe(function (paymetList) {
            _this.paymentDetlList = paymetList;
            _this.dataSourcePayment.data = _this.paymentDetlList;
            //this.getpaymentDetails();
        });
    };
    BillingUpdateComponent.prototype.productInitList = function () {
        var _this = this;
        this._contactService.productInitList(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT + 'getproductInitList', this.billNumber).subscribe(function (productInitList) {
            _this.productInitListData = productInitList;
            for (var kt = 0; kt < _this.dataSource.data.length; kt++) {
                _this.dataSource.data[kt].name = _this.productInitListData[kt].name;
            }
            _this.dataSource.data = _this.BillingDtlList;
        });
    };
    //*****************billing details list*****************
    BillingUpdateComponent.prototype.billDetailListAmountList = function () {
        var _this = this;
        this._contactService.getManuList2134(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT + 'getAmounrDtlListUpdate', this.billNumber).subscribe(function (amountDetails) {
            _this.BillingDtlList = amountDetails;
            _this.dataSource.data = _this.BillingDtlList;
        });
    };
    BillingUpdateComponent.prototype.getblgDetails = function () {
        var _this = this;
        for (var i = 0; i < this.BillingDtlList.length; i++) {
            if (this.BillingDtlList[i].bill == this.billNumber) {
                var billIndex = this.BillingDtlList.findIndex(function (x) { return x.bill === _this.billNumber; });
    ...
    BillingUpdateComponent.prototype.getpaymentDetails = function () {
        var _this = this;
        for (var i = 0; i < this.paymentDetlList.length; i++) {
            if (this.paymentDetlList[i].bill == this.billNumber) {
                var paymentIndex = this.paymentDetlList.findIndex(function (x) { return x.bill === _this.billNumber; });
    ...
    BillingUpdateComponent.prototype.deleteAll = function (formDataz, datattt, dataPayment) {
        var _this = this;
        this._contactService.deleteBillingHeader(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'deleteBillingHeader', this.billNumber).subscribe(function (data) {
            //deletePayment    
            _this._contactService.deleteBillingDtl(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'deleteBillingDtl', _this.billNumber).subscribe(function (data) {
                alert(data);
            }, function (error) {
                //  alert(error);
        ...
        this._contactService.paymenttes(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'deletePaymentAmt', this.billNumber).subscribe(function (data) {
            _this._contactService.deletePaymentdtl(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'deletePaymentdtl', _this.billNumber).subscribe(function (data) {
            }, function (error) {
                _this.onSubmitSaved(formDataz, datattt, dataPayment);
                // alert(error);
                // this.dialogRef.close('error');
            });
        });
    ...
    //Update
    BillingUpdateComponent.prototype.onSubmitSaved = function (formDataz, datattt, dataPayment) {
        var _this = this;
        if (formDataz.value.CusAddress != null && formDataz.value.bill != null && datattt.length != 0 && dataPayment != null) {
            this._contactService.saveBillingHdr(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'saveBillingHdr', formDataz.value).subscribe(function (data) {
                // Success
                if (data.message) {
                    _this.returnId = data.message;
                    if (datattt.length == 0) {
                        ...
                        for (var i = 0; i < dataPayment.length; i++) {
                            dataPayment[i].billingHdrId = _this.returnId;
                            _this._contactService.savePayment(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'addPayment', dataPayment[i]).subscribe(function (data) {
                                _this._contactService.totalAmountCalculation(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'totalAmount', formDataz.value).subscribe(function (data) {
                                    // Success
                                    if (data.id) {
                        ...
                        for (var i = 0; i < datattt.length; i++) {
                            ...
                            datattt[i].billingHdrId = _this.returnId;
                            // var eachObject = data[i];
                            _this._contactService.saveBillingUpdate(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'addBillingUpdate', datattt[i]).subscribe(function (data) {
                                // Success
                ...
                _this.snackBar.open("Data Saved Successfully", '', {
                    duration: 3000
                });
                _this.dataSource.data = [];
                _this.dataSourcePayment.data = [];
                _this.billingFrm = _this.fb.group({
                    name: [],
                    amount: [],
                    quantity: [''],
    ...
    BillingUpdateComponent.prototype.onSubmitpayment = function (formData) {
        var finaldata = formData.value;
        this.addRowPayment(finaldata);
        this.dataSourcePayment.data.push(finaldata);
    };
    //AMount Add button func
    BillingUpdateComponent.prototype.onSubmit = function (formData) {
        var finaldata = formData.value;
        this.addRow(finaldata);
        this.totalAddAmount = this.dataSource.data.reduce(function (summ, v) { return summ += (v.amount); }, 0);
        this.billingFrm = this.fb.group({
            id: [this.indexValueRename],
    ...
    BillingUpdateComponent.prototype.addRow = function (finaldata) {
        if (this.isEdit == true) {
            this.dataSource.data.splice(finaldata.id, 1);
            //this.dataSource.data.length = (this.dataSource.data.length)-1;
            this.dataSource.data = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.dataSource.data, [finaldata]);
    ...
    BillingUpdateComponent.prototype.addRowPayment = function (finaldata) {
        if (this.dataSourcePayment.data.length > 1) {
            this.dataSourcePayment.data.length = (this.dataSourcePayment.data.length) - 1;
            this.dataSourcePayment.data = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.dataSourcePayment.data, [finaldata]);
        }
        else {
            this.dataSourcePayment.data = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.dataSourcePayment.data, [finaldata]);
        }
    ...
    BillingUpdateComponent.prototype.selected = function (indexs) {
        var indexValue = this.productList.findIndex(function (x) { return x.id === indexs.value; });
        var prodName = this.productList[indexValue].name;
        var result = this.productList[indexValue].sellingCost;
    ...
    BillingUpdateComponent.prototype.editBilling = function (id, datas) {
        this.isEdit = true;
        var finaldatus = datas;
    ...
    BillingUpdateComponent.prototype.editPayment = function (id, datas) {
        var finaldatus = datas;
    ...
    BillingUpdateComponent.prototype.removeSelectedRowsPayment = function (index, formDatatab) {
        if (this.dataSourcePayment.data.length < 1) {
            this.dataSourcePayment.data = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.dataSourcePayment.data);
        }
        else {
            this.dataSourcePayment.data.length = (this.dataSourcePayment.data.length) - 1;
    ...
    BillingUpdateComponent.prototype.removeSelectedRows = function (index, formDatatab) {
        if (this.dataSource.data.length < 1) {
            this.dataSource.data = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.dataSource.data);
        }
        else {
            // this.dataSource.data.length = (this.dataSource.data.length)-1;
    ...
    BillingUpdateComponent.prototype.hideDiv = function () {
    };
    BillingUpdateComponent.ctorParameters = function () { return [
...
var BillingViewComponent = /** @class */ (function () {
    function BillingViewComponent(snackBar, router, dialog, fb, datePipe, _contactService) {
        this.snackBar = snackBar;
        this.router = router;
        this.dialog = dialog;
        this.fb = fb;
    ...
    BillingViewComponent.prototype.ngOnInit = function () {
    ...
    BillingViewComponent.prototype.customerList = function () {
        var _this = this;
        this._contactService.getCustomerList(_shared_Global__WEBPACK_IMPORTED_MODULE_4__["Global"].BASE_USER_ENDPOINT_CUST + 'getCustomerList')
            .subscribe(function (customers) {
            _this.dataSourceCustomer.data = customers;
        });
    };
    BillingViewComponent.prototype.TestList = function () {
        var _this = this;
    ...
    BillingViewComponent.prototype.totalValues = function () {
        var _this = this;
        this._contactService.totalAmount(_shared_Global__WEBPACK_IMPORTED_MODULE_4__["Global"].BASE_USER_ENDPOINT + 'totalAmount', this.billNumberParam).subscribe(function (amountDetails) {
            _this.amountListDataSrc.data = amountDetails;
        });
    };
    ///EDIT
    BillingViewComponent.prototype.editBilling = function (id, datas) {
        this.dbops = _shared_DBOperation__WEBPACK_IMPORTED_MODULE_7__["DBOperation"].update;
        this.modalTitle = 'Edit Billing';
        this.modalBtnTitle = 'Update';
        this.manufacturer = this.dataSource.data.filter(function (x) { return x.bill === datas.bill; })[0];
    ...
    //Detail List
    BillingViewComponent.prototype.billDetailListAmountList = function () {
        var _this = this;
        this._contactService.getManuList213(_shared_Global__WEBPACK_IMPORTED_MODULE_4__["Global"].BASE_USER_ENDPOINT + 'getAmounrDtlList').subscribe(function (amountDetails) {
            _this.amountListDataSrc.data = amountDetails;
            _this.savedTotalAMount.data = amountDetails;
        });
    };
    //*****************Biliing Header Details************** */
    BillingViewComponent.prototype.getBillingHeaderDetails = function () {
        var _this = this;
        this._contactService.getManuList21(_shared_Global__WEBPACK_IMPORTED_MODULE_4__["Global"].BASE_USER_ENDPOINT + 'getbillingDtl')
            .subscribe(function (headerLst) {
            _this.BillingHeaderDetails.data = headerLst;
        });
    };
    BillingViewComponent.prototype.billDetailList = function () {
        var _this = this;
        this.dataSource.data = [];
        ...
        if (this.billingListFrm.value.fromDate != '' && this.billingListFrm.value.toDate != '' && this.billingListFrm.value.code != '') {
            if (this.billingListFrm.value.fromDate.getTime() < this.billingListFrm.value.toDate.getTime()) {
                this._contactService.getManuList21(_shared_Global__WEBPACK_IMPORTED_MODULE_4__["Global"].BASE_USER_ENDPOINT + 'getbillingDtl')
                    .subscribe(function (billingDtl) {
                    _this.dataSourceDup.data = billingDtl;
                    if (_this.billingListFrm.value.code != '' && _this.billingListFrm.value.mobile == '') {
                        for (var i = 0; i < _this.dataSourceDup.data.length; i++) {
                            if (_this.dataSourceDup.data[i].code == _this.billingListFrm.value.code) {
                                var cusMbilendex = _this.dataSourceCustomer.data.findIndex(function (x) { return x.code === _this.billingListFrm.value.code; });
                                _this.customerName = _this.dataSourceCustomer.data[cusMbilendex].name;
                                _this.customerMobileNum = _this.dataSourceCustomer.data[cusMbilendex].mobile;
                                _this.customerBillNumber = _this.dataSourceDup.data[i].bill;
                                _this.billNumberParam = _this.dataSourceDup.data[i].bill;
                                _this.dataSourceDup2.data.push(_this.dataSourceDup.data[i]);
                            }
                            else if (_this.dataSourceDup.data[i].mobile == _this.billingListFrm.value.mobile) {
                            }
                        }
                        for (var leng = 0; leng < _this.dataSourceDup2.data.length; leng++) {
                            var newDate = new Date(_this.dataSourceDup2.data[leng].date);
                            var fromDate = new Date(_this.billingListFrm.value.fromDate);
                            var toDate = new Date(_this.billingListFrm.value.toDate);
                            if (fromDate < newDate && newDate < toDate) {
                                _this.dataSourceDup5.data[leng] = _this.dataSourceDup2.data[leng];
                            }
                            else {
                                _this.snackBar.open("No Records Found Between the Given Date", '', {
                                    duration: 3000
                                });
                            }
                        }
                        _this.dataSource.data = _this.dataSourceDup5.data;
                        for (i = 0; i < _this.dataSource.data.length; i++) {
                            _this.dataSource.data[i].name = _this.customerName;
                            _this.dataSource.data[i].mobile = _this.customerMobileNum;
                            // this.dataSource.data[i].amount=this.testAmount[i];
                            var amntIndx = _this.testData.findIndex(function (x) { return x.bill.trim().toLocaleLowerCase() === _this.dataSource.data[i].bill; });
                            _this.dataSource.data[i].amount = _this.testData[amntIndx].totalAddAmount;
                        }
            ...
            var datas = this.dataSourceCustomer.data.findIndex(function (x) { return x.mobile === _this.billingListFrm.value.mobile; });
            ...
            for (var loott = 0; loott < this.BillingHeaderDetails.data.length; loott++) {
                if (this.BillingHeaderDetails.data[loott].code == this.billingListFrm.value.code) {
                    var cusMbilendex = this.dataSourceCustomer.data.findIndex(function (x) { return x.code === _this.billingListFrm.value.code; });
            ...
            for (i = 0; i < this.dataSource.data.length; i++) {
                ...
                var amntIndx = this.testData.findIndex(function (x) { return x.bill.trim().toLocaleLowerCase() === _this.dataSource.data[i].bill; });
        ...
        //******************************ALL EMPTY************************************************
            ...
            for (var i = 0; i < this.dataSource.data.length; i++) {
                var cusMbilendex = this.dataSourceCustomer.data.findIndex(function (x) { return x.code === _this.dataSource.data[i].code; });
                this.customerName = this.dataSourceCustomer.data[cusMbilendex].name;
                this.customerMobileNum = this.dataSourceCustomer.data[cusMbilendex].mobile;
                var amntIndx = this.testData.findIndex(function (x) { return x.bill.trim().toLocaleLowerCase() === _this.dataSource.data[i].bill; });
                this.dataSource.data[i].amount = this.testData[amntIndx].totalAddAmount;
        ...
        //**********FROM DATE & TO DATA**************** */
            ...
            for (var leng = 0; leng < this.BillingHeaderDetails.data.length; leng++) {
                var newDate = new Date(this.BillingHeaderDetails.data[leng].date);
                var fromDate = new Date(this.billingListFrm.value.fromDate);
                var toDate = new Date(this.billingListFrm.value.toDate);
                if (fromDate < newDate && newDate < toDate) {
                    ...
                    var amntIndx = this.testData.findIndex(function (x) { return x.bill.trim().toLocaleLowerCase() === _this.dataSourceDup2.data[leng].bill; });
    ...
    BillingViewComponent.prototype.resetPage = function () {
        this.billingListFrm = this.fb.group({
            code: [''],
            mobile: [''],
            fromDate: [''],
    ...
    BillingViewComponent.prototype.onSubmitSave = function (data, formData) {
    };
    BillingViewComponent.prototype.searchCustomer = function (formData) {
        var _this = this;
        ...
        if (formData.value.mobile != '' && formData.value.code == '') {
            for (var i = 0; i < this.billingDtlList.length; i++) {
                if (this.billingDtlList[i].bill == formData.value.bill) {
                    var cusMbilendex_1 = this.dataSourceCustomer.data.findIndex(function (x) { return x.code === _this.billingListFrm.value.code; });
                    var customerName = this.dataSourceCustomer.data[cusMbilendex_1].name;
                ...
                var cusMbilendex = this.billingDtlList[i].findIndex(function (x) { return x.bill.trim().toLocaleLowerCase() === formData.value.bill; });
    ...
    BillingViewComponent.ctorParameters = function () { return [
...
var BillinglistComponent = /** @class */ (function () {
    function BillinglistComponent(snackBar, fb, _contactService) {
        this.snackBar = snackBar;
        this.fb = fb;
        this._contactService = _contactService;
    ...
    BillinglistComponent.prototype.onSearchChange = function (searchValue) {
        this.totalCost = this.billingFrm.value.price * searchValue;
        this.billingFrm = this.fb.group({
            id: [this.indexValueRename],
            price: [this.billingFrm.value.price],
    ...
    BillinglistComponent.prototype.manuList = function () {
        var _this = this;
        this._contactService.getManuList2(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT + 'getAllProd')
            .subscribe(function (manufacturer) {
            _this.productList = manufacturer;
    ...
    BillinglistComponent.prototype.changeClient = function (data) {
        alert("selected --->" + data);
    };
    BillinglistComponent.prototype.findForeignKey = function () {
        var _this = this;
        this._contactService.getBillingHdrDetails(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT + 'getBillingHdrDetails')
            .subscribe(function (manufacturer) {
            _this.hdrDetails = manufacturer;
        });
    };
    BillinglistComponent.prototype.onSubmitSaved = function (formDataz, datattt, dataPayment) {
        var _this = this;
        this._contactService.totalAmountCalculation(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'totalAmount', formDataz.value).subscribe(function (data) {
            // Success
            if (data.id) {
                //    this.dialogRef.close('success');
            }
                ...
                if (data.message) {
                    ...
                    if (datattt.length == 0) {
                        ...
                        for (var i = 0; i < datattt.length; i++) {
                            ...
                            datattt[i].billingHdrId = _this.returnId;
                            // var eachObject = data[i];
                            _this._contactService.saveBilling(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'addBilling', datattt[i]).subscribe(function (data) {
                                // Success
                                if (data.id) {
                                    //    this.dialogRef.close('success');
                                }
    ...
    BillinglistComponent.prototype.onSubmit = function (formData) {
        var finaldata = formData.value;
        this.addRow(finaldata);
        this.totalAddAmount = this.dataSource.data.reduce(function (summ, v) { return summ += (v.amount); }, 0);
        this.billingFrm = this.fb.group({
    ...
    BillinglistComponent.prototype.finalForeign = function () {
        var _this = this;
        this._contactService.getBillingHdrDetails(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT + 'getBillingHdrDetails')
            .subscribe(function (manufacturer) {
            _this.hdrDetailsFinal = manufacturer;
        });
    };
    BillinglistComponent.prototype.onSubmitpayment = function (formData) {
        var finaldata = formData.value;
        this.addRowPayment(finaldata);
        this.dataSourcePayment.data.push(finaldata);
    };
    BillinglistComponent.prototype.applyFilter = function (val) {
        console.log(val);
    };
    BillinglistComponent.prototype.addRowPayment = function (finaldata) {
    ...
    BillinglistComponent.prototype.addRow = function (finaldata) {
        if (this.isEdit == true) {
            this.dataSource.data.splice(finaldata.id, 1);
            this.dataSource.data.length = (this.dataSource.data.length) - 1;
            this.dataSource.data = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.dataSource.data, [finaldata]);
    ...
    BillinglistComponent.prototype.editBilling = function (id, datas) {
        this.isEdit = true;
        var finaldatus = datas;
        this.dataSource.data;
        console.log(id, finaldatus);
    ...
    BillinglistComponent.prototype.editPayment = function (id, datas) {
        var finaldatus = datas;
        this.dataSourcePayment.data;
        console.log(id, finaldatus);
        this.billingFrm = this.fb.group({
    ...
    BillinglistComponent.prototype.calculate = function (first, second) {
        this.third = first + second;
    };
    BillinglistComponent.prototype.removeSelectedRows = function (index, formDatatab) {
        if (this.dataSource.data.length < -1) {
            this.dataSource.data = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.dataSource.data);
        }
        else {
    ...
    BillinglistComponent.prototype.removeSelectedRowsPayment = function (index, formDatatab) {
        if (this.dataSourcePayment.data.length < -1) {
            this.dataSourcePayment.data = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.dataSourcePayment.data);
        }
        else {
    ...
    BillinglistComponent.prototype.selected = function (indexs) {
        var _this = this;
        var indexValue = this.productList.findIndex(function (x) { return x.id === indexs.value; });
        var prodName = this.productList[indexValue].name;
        var result = this.productList[indexValue].sellingCost;
        ...
        this._contactService.getManuList21(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT + 'getbillingDtl')
            .subscribe(function (headerLst) {
            _this.BillingHeaderDetails.data = headerLst;
            var findBillExIndex = _this.BillingHeaderDetails.data.findIndex(function (x) { return x.bill === _this.billNum; });
            if (findBillExIndex != -1) {
                _this.snackBar.open("Bill Number Already Exist", '', {
                    duration: 3000
                });
                _this.billingFrm = _this.fb.group({
                    id: [_this.indexValueRename],
                    price: [_this.resultRename],
                    name: [_this.prodNameRename],
                    quantity: [''],
                    amount: [''],
                    sellingCost: [''],
                    code: [_this.codeRename],
                    date: [_this.date.value],
                    bill: [''],
                    mobile: [_this.mobileRename],
                    paymentType: [''],
                    referenceNo: [''],
                    cusName: [_this.cusNameRename],
                    CusAddress: [_this.cusAddressRename],
                    totalAddAmount: [_this.totalAddAmount]
                });
                _this.dataSource.data = [];
            }
            else {
    ...
    BillinglistComponent.prototype.trackHero = function (index, product) {
        console.log(product);
        //this.bill
        //  this.billingFrm.price= product.sellingCost;
        return product ? product.id : undefined;
    };
    BillinglistComponent.prototype.hideDiv = function () {
        this.billingFrm.controls['price'].disable();
        this.billingFrm.controls['name'].disable();
    };
    //Customer List
    BillinglistComponent.prototype.customerListMeth = function () {
        var _this = this;
        this._contactService.getCustomerList(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'getCustomerList')
            .subscribe(function (customers) {
            _this.customerList = customers;
    ...
    BillinglistComponent.prototype.reset = function () {
        this.billingFrm = this.fb.group({
            id: [this.indexValueRename],
            price: [this.resultRename],
            name: [this.prodNameRename],
    ...
    BillinglistComponent.prototype.searchCustomer = function (formData) {
        if (formData.value.code != '' && formData.value.mobile == '' || formData.value.mobile == null) {
            var cusNamendex = this.customerList.findIndex(function (x) { return x.code.trim().toLocaleLowerCase() === formData.value.code; });
            if (cusNamendex >= 0) {
                var cusName = this.customerList[cusNamendex].name;
                var cusAddress = this.customerList[cusNamendex].address;
            ...
            var cusMbilendex = this.customerList.findIndex(function (x) { return x.mobile.trim().toLocaleLowerCase() === formData.value.mobile; });
            if (cusMbilendex >= 0) {
                var cusName = this.customerList[cusMbilendex].name;
                var cusAddress = this.customerList[cusMbilendex].address;
                this.codeRename = formData.value.code;
                this.mobileRename = formData.value.mobile;
                this.cusNameRename = cusName;
                this.cusAddressRename = cusAddress;
...
var CustomerAddformComponent = /** @class */ (function () {
    function CustomerAddformComponent(data, fb, _contactService, dialogRef) {
        this.data = data;
        this.fb = fb;
        this._contactService = _contactService;
        this.dialogRef = dialogRef;
    ...
    CustomerAddformComponent.prototype.onSubmit = function (formData) {
        var _this = this;
        var customerData = this.mapDateData(formData.value);
        switch (this.data.dbops) {
            case _shared_DBOperation__WEBPACK_IMPORTED_MODULE_4__["DBOperation"].create:
                formData.value.id = 5;
                this._contactService.addCustomer(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'addCustomer', customerData).subscribe(function (data) {
                    // Success
                    if (data.message) {
                        _this.dialogRef.close('success');
                    }
            ...
            case _shared_DBOperation__WEBPACK_IMPORTED_MODULE_4__["DBOperation"].update:
                this._contactService.updateCustomer(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'updateCustomer', customerData.id, customerData).subscribe(function (data) {
                    // Success
                    if (data.message) {
                        _this.dialogRef.close('success');
                    }
            ...
            case _shared_DBOperation__WEBPACK_IMPORTED_MODULE_4__["DBOperation"].delete:
                this._contactService.deleteCustomer(_shared_Global__WEBPACK_IMPORTED_MODULE_5__["Global"].BASE_USER_ENDPOINT_CUST + 'deleteCustomer', customerData.id).subscribe(function (data) {
                    // Success
                    if (data.message) {
                        _this.dialogRef.close('success');
                    }
    ...
    CustomerAddformComponent.prototype.mapDateData = function (customerData) {
        return customerData;
    };
    CustomerAddformComponent.prototype.SetControlsState = function (isEnable) {
        isEnable ? this.customerFrm.enable() : this.customerFrm.disable();
    };
    CustomerAddformComponent.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_3__["MAT_DIALOG_DATA"],] }] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
var CustomerListComponent = /** @class */ (function () {
    function CustomerListComponent(snackBar, _contactService, dialog) {
        var _this = this;
        this.snackBar = snackBar;
        this._contactService = _contactService;
        this.dialog = dialog;
    ...
    CustomerListComponent.prototype.openDialog = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_customer_addform_customer_addform_component__WEBPACK_IMPORTED_MODULE_6__["CustomerAddformComponent"], {
            width: '500px',
    ...
    CustomerListComponent.prototype.customerList = function () {
        var _this = this;
    ...
    CustomerListComponent.prototype.deleteCustomer = function (id) {
        ...
        this.modalBtnTitle = 'Delete';
        this.customer = this.dataSource.data.filter(function (x) { return x.id === id; })[0];
        this.openDialog();
    };
    ...
    CustomerListComponent.prototype.showMessage = function (msg) {
        this.snackBar.open(msg, '', {
            duration: 3000
        });
    };
...
var ManufacturerAddComponent = /** @class */ (function () {
    function ManufacturerAddComponent(data, fb, _contactService, dialogRef) {
        this.data = data;
        this.fb = fb;
        this._contactService = _contactService;
        this.dialogRef = dialogRef;
    }
    ManufacturerAddComponent.prototype.ngOnInit = function () {
    ...
    ManufacturerAddComponent.prototype.onSubmit = function (formData) {
        var _this = this;
        var manufData = this.mapDateData(formData.value);
        switch (this.data.dbops) {
            case _shared_DBOperation__WEBPACK_IMPORTED_MODULE_3__["DBOperation"].create:
                formData.value.id = 5;
                this._contactService.addManufacturer(_shared_Global__WEBPACK_IMPORTED_MODULE_4__["Global"].BASE_USER_ENDPOINT_MANU + 'addManufacturer', manufData).subscribe(function (data) {
                    // Success
                    if (data.message) {
                        _this.dialogRef.close('success');
                    }
            ...
            case _shared_DBOperation__WEBPACK_IMPORTED_MODULE_3__["DBOperation"].update:
                this._contactService.updateManufacturer(_shared_Global__WEBPACK_IMPORTED_MODULE_4__["Global"].BASE_USER_ENDPOINT_MANU + 'updateManufacturer', manufData.id, manufData).subscribe(function (data) {
                    // Success
                    if (data.message) {
                        _this.dialogRef.close('success');
                    }
            ...
            case _shared_DBOperation__WEBPACK_IMPORTED_MODULE_3__["DBOperation"].delete:
                this._contactService.deleteManufacturer(_shared_Global__WEBPACK_IMPORTED_MODULE_4__["Global"].BASE_USER_ENDPOINT_MANU + 'deleteManufacturer', manufData.id).subscribe(function (data) {
                    // Success
                    if (data.message) {
                        _this.dialogRef.close('success');
                    }
    ...
    ManufacturerAddComponent.prototype.mapDateData = function (manufac) {
        //contact.birth = new Date(contact.birth).toISOString();
        return manufac;
    };
    ManufacturerAddComponent.prototype.SetControlsState = function (isEnable) {
        isEnable ? this.manuFrm.enable() : this.manuFrm.disable();
    };
    ManufacturerAddComponent.ctorParameters = function () { return [
    ...
    return ManufacturerAddComponent;
}());
...
var ManufacturerComponent = /** @class */ (function () {
    function ManufacturerComponent(snackBar, _contactService, dialog) {
        var _this = this;
        this.snackBar = snackBar;
        this._contactService = _contactService;
        this.dialog = dialog;
    ...
    ManufacturerComponent.prototype.openDialog = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_manufacturer_add_Manufacturer_add_component__WEBPACK_IMPORTED_MODULE_6__["ManufacturerAddComponent"], {
            width: '1500px',
    ...
    ManufacturerComponent.prototype.manuList = function () {
        var _this = this;
        this._contactService.getManuList(_shared_Global__WEBPACK_IMPORTED_MODULE_4__["Global"].BASE_USER_ENDPOINT + 'getAllManu')
            .subscribe(function (manufacturer) {
            _this.dataSource.data = manufacturer;
        });
    };
    ManufacturerComponent.prototype.editManu = function (id) {
        this.dbops = _shared_DBOperation__WEBPACK_IMPORTED_MODULE_5__["DBOperation"].update;
        this.modalTitle = 'Edit Manufacture';
        this.modalBtnTitle = 'Update';
        this.manufacturer = this.dataSource.data.filter(function (x) { return x.id === id; })[0];
        this.openDialog();
    };
    ManufacturerComponent.prototype.deleteManu = function (id) {
        this.dbops = _shared_DBOperation__WEBPACK_IMPORTED_MODULE_5__["DBOperation"].delete;
    ...
    ManufacturerComponent.prototype.addManufacturer = function () {
        this.dbops = _shared_DBOperation__WEBPACK_IMPORTED_MODULE_5__["DBOperation"].create;
        this.modalTitle = 'Add new ';
        this.modalBtnTitle = 'Save';
        this.openDialog();
    };
    ManufacturerComponent.prototype.showMessage = function (msg) {
        this.snackBar.open(msg, '', {
            duration: 3000
        });
    };
    ManufacturerComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"] },
        { type: _services_contact_service__WEBPACK_IMPORTED_MODULE_3__["ContactService"] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialog"] }
    ]; };
...
var ContactService = /** @class */ (function () {
    ...
    ContactService.prototype.getManuList = function (url) {
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.getBillingHdrDetails = function (url) {
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.getManuList2 = function (url) {
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.getManuList21 = function (url) {
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.getManuList213 = function (url) {
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.getManuList2134 = function (url, bill) {
        var newurl = url + "?bill=" + bill;
        return this.http.get(newurl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.getManuListPayment = function (url) {
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.getManuListPaymentLatest = function (url, bill) {
        var newurl = url + "?bill=" + bill;
        return this.http.get(newurl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.productInitList = function (url, bill) {
        var newurl = url + "?bill=" + bill;
        return this.http.get(newurl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.getProductList = function (url) {
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.getBillDelParam = function (url, billnumber) {
        var newurl = url + "?bill=" + billnumber;
        return this.http.get(newurl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.totalAmount = function (url, data) {
        var newurl = url + "?bill=" + data;
        return this.http.get(newurl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ...
    ContactService.prototype.saveBilling = function (url, contact) {
        var parameter = {
            bill: contact.bill,
            price: contact.price,
    ...
    ContactService.prototype.saveBillingUpdate = function (url, contact) {
        var parameter = {
            bill: contact.bill,
            price: contact.price,
            amount: contact.amount,
    ...
    ContactService.prototype.totalAmountCalculation = function (url, contact) {
        var parameter = {
            bill: contact.bill,
    ...
    ContactService.prototype.savePayment = function (url, contact) {
        var parameter = {
            billingHdrId: contact.billingHdrId,
            bill: contact.bill,
    ...
    //Billing Header
    ContactService.prototype.saveBillingHdr = function (url, contact) {
        var parameter = {
    ...
    //Add manufacturer
    // insert new contact details    
    ContactService.prototype.addManufacturer = function (url, contact) {
        return this.http.post(url, JSON.stringify(contact), httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    // update Manufacturer
    ContactService.prototype.updateManufacturer = function (url, id, contact) {
        var newurl = url + "?id=" + id;
        return this.http.put(newurl, contact, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    //delete manufacturer
    // delete contact information    
    ContactService.prototype.deleteManufacturer = function (url, id) {
        var newurl = url + "?id=" + id;
        return this.http.delete(newurl, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ////Get Customer List
    ContactService.prototype.getCustomerList = function (url) {
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.getAmountTest = function (url) {
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    //Update Customer
    ContactService.prototype.updateCustomer = function (url, id, contact) {
        var newurl = url + "?id=" + id;
        return this.http.put(newurl, contact, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.deleteCustomer = function (url, id) {
        var newurl = url + "?id=" + id;
        return this.http.delete(newurl, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.paymenttes = function (url, bill) {
        var newurl = url + "?bill=" + bill;
        return this.http.delete(newurl, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.deletePayment = function (url, bill) {
        var newurl = url + "?bill=" + bill;
        return this.http.delete(newurl, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.deletePaymentdtl = function (url, bill) {
        var newurl = url + "?bill=" + bill;
        return this.http.delete(newurl, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.deleteBillingDtl = function (url, bill) {
        var newurl = url + "?bill=" + bill;
        return this.http.delete(newurl, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.deleteBillingHeader = function (url, id) {
        var newurl = url + "?id=" + id;
        return this.http.delete(newurl, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.addCustomer = function (url, contact) {
        return this.http.post(url, JSON.stringify(contact), httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    ContactService.prototype.getPriceAmt = function (url, indexsx) {
        var newurl = url + "?name=" + indexsx;
